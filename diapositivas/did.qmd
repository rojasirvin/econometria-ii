...
- Notación basada en [Roth et al.](https://www.sciencedirect.com/science/article/pii/S0304407623001318?casa_token=uID5K1tUoCkAAAAA:fu6BhPOhjQTti8tyxACl14raIRFs_RAvzgqui7h2-KGu4b9BdcOTP5mtcrsNTQaj0LvvYsUrK0Sp)
...
$$E(y_{i1}(0)|D_i=1)=E(y_{i0}(0)|D_i=1)+E(y_{i1}(0)-y_{i0}(0)|D_i=0)$$
- Usando el supuesto de no anticipación
...
$$y_{it}=\alpha_i+\phi_t + \mathbf{1}(t=1)D_i\tau+\varepsilon_{it}$$
- Donde $\mathbf{1}(t=1)$ es la función indicadora que toma el valor de 1 cuando la condición $(t=1)$ es verdadera
...
$$y_{it}=\alpha_i+\phi_t + \mathbf{1}(t>t_0)D_i\tau+\varepsilon_{it}$$
- También podríamos reducir el problema a uno con solo dos periodos al promediar los valores de la variable dependiente en los periodos pre y post intervención
...
- Roth, J., Sant’Anna, P. H., Bilinski, A., & Poe, J. (2023). [What’s trending in difference-in-differences? A synthesis of the recent econometrics literature](https://www.sciencedirect.com/science/article/pii/S0304407623001318?casa_token=8KY9wpOi6rEAAAAA:8T5yj82wECuxhmBvkggsJgsDVS65i0VFcVBkeS7xfeECrWxSUTTZfGtF1ldtX9RTx6tvgFKpzCZ0). *Journal of Econometrics*, 235(2), 2218-2244.

- Callaway, B., & Sant’Anna, P. H. (2021). [Difference-in-differences with multiple time periods](https://www.sciencedirect.com/science/article/pii/S0304407620303948?casa_token=T4b4lObaSC4AAAAA:UmDeziMcwM4vh4azo_R8ZVrDlMypg3JzGOdrJgt_K8G9E2XEn5l8LQEAyhkMkhkpjEp9w4t4CrlH). *Journal of Econometrics*, 225(2), 200-230.
